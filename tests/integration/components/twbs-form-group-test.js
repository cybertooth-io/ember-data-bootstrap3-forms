...
module('Integration | Component | twbs form group', function (hooks) {
  ...
  test('when field errors are not supplied then simply behave as a form-group', async function (assert) {
    ...
    assert.dom('.form-group > .help-block.twbs-form-group-errors').doesNotExist();
  });
  ...
  test('when a single error is present', async function (assert) {
    ...
    assert.dom('.form-group > .help-block.twbs-form-group-errors').exists({ count: 1 });
    assert
      .dom('.form-group > .help-block.twbs-form-group-errors > .twbs-form-group-error-message')
  ...
  test('when multiple errors are present', async function (assert) {
    ...
    assert
      ...
      .hasText('Some sort of error.');
    assert
      .dom(findAll('.form-group > .help-block.twbs-form-group-errors > .twbs-form-group-error-message')[1])
